import GuaranteeGallery, { type GalleryPanel } from "@/components/GuaranteeGallery";
...
const panels: GalleryPanel[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      <p key="pull" className="pull">
        We asked. <em>The scale said no.</em>
      </p>,
...
export default function Guarantee() {
  return (
    <section className="guarantee" id="guarantee" data-ui="light">
      <div className="container">
        <header className="guarantee__head reveal">
          <span className="eyebrow">The Wooster Prep score guarantee</span>
          <h2 className="guarantee__title">100 points higher, or the course again for free.</h2>
          <p className="lede">
            Here is the promise, in one sentence, because a promise that needs three paragraphs usually isn’t one:
            if your official SAT score is 1300 or below, we guarantee your next official score will be at least 100
            points higher, or you take the whole course again for free.
          </p>
        </header>
      </div>

      <GuaranteeGallery panels={panels} />
